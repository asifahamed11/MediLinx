    ...
    <div class="content">
        ...
        <div class="profile-header">
            <?php if ($doctor['profile_image']): ?>
                <img src="../<?= htmlspecialchars($doctor['profile_image']) ?>" alt="Profile Image" class="profile-img">
            <?php else: ?>
                <img src="../uploads/doctors/default.png" alt="Default Profile Image" class="profile-img">
            <?php endif; ?>
