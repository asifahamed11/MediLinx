...
<head>
    ...
    <title>Add New Patient - Medilinx Admin</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="section">
                ...
                <p style="margin-bottom: 15px;">Add any relevant medical history for the patient (optional).</p>
                ...
                <button type="button" id="add-history" class="btn btn-secondary">Add Medical History</button>
            </div>

            <div style="margin-top: 20px; text-align: center;">
                <button type="submit" class="btn btn-primary">Add Patient</button>
                <a href="admin.php?tab=patients" class="btn btn-secondary" style="text-decoration: none;">Cancel</a>
            </div>
        </form>
    </div>
